...
<div class="container">
  <div class="card shadow-sm mb-3">
    <div class="card-body">
      <h1 class="h6">相談一覧（管理者）</h1>

      <form class="row g-2" method="get" action="<%= request.getContextPath() %>/admin/consult/list">
        <div class="col-md-3">
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-sm btn-outline-primary"
                   href="<%= request.getContextPath() %>/admin/consult/detail?id=<%= c.getId() %>">詳細</a>
              </td>
            </tr>
          <%
              }
