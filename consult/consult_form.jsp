            ...
            <form method="post" action="<%= request.getContextPath() %>/consult/confirm">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <textarea name="summary" rows="5" class="form-control"
                                      placeholder="例）上司から繰り返し叱責されている…"><%= old(request, "summary") %></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <input type="radio" class="form-check-input" name="reportedExists"
                                   value="YES" <%= oldRadio(request,"reportedExists","YES","")?"checked":"" %>>
                            <label class="form-check-label">はい</label>

                            <input type="radio" class="form-check-input ms-3" name="reportedExists"
                                   value="NO" <%= oldRadio(request,"reportedExists","NO","")?"checked":"" %>>
                            <label class="form-check-label">いいえ</label>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">相談相手</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">相談日時</label>
                            <input type="text" class="form-control"
                                   name="reportedAt"
                        ...
                        <div class="mb-3">
                            <label class="form-label">その後の対応</label>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 mt-3">
                            <label class="form-label">心身の状態の詳細</label>
                ...
                <!-- 5. 今後の希望 -->
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-success text-white">今後の希望（複数可）</div>

                    <div class="card-body">
                        <label class="form-text mb-2">希望する対応を選んでください。</label>

                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="LISTEN_ONLY"
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="ADVISE"
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="ARRANGE_MEETING"
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="KEEP_RECORD"
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="WORK_CHANGE"
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="NOTHING"
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input"
                                   name="futureRequest" value="OTHER"
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="small text-muted">相談内容をどこまで共有してよいかを選択してください。</p>

                        <div class="form-check">
                            <input type="radio" class="form-check-input"
                                   name="sharePermission" value="ALL_OK"
                                   <%= oldRadio(request,"sharePermission","ALL_OK","ALL_OK")?"checked":"" %>>
                            <label class="form-check-label">必要な関係者には共有してよい</label>
                        </div>

                        <div class="form-check">
                            <input type="radio" class="form-check-input"
                                   name="sharePermission" value="LIMITED"
                                   <%= oldRadio(request,"sharePermission","LIMITED","ALL_OK")?"checked":"" %>>
                            <label class="form-check-label">共有相手を限定したい</label>
                        </div>

                        <input type="text" name="shareLimitedTargets"
                               class="form-control ms-4 mb-3"
                               value="<%= old(request,"shareLimitedTargets") %>"
                               placeholder="例）人事担当のみ">

                        <div class="form-check">
                            <input type="radio" class="form-check-input"
                                   name="sharePermission" value="NO_SHARE"
