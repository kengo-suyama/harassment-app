  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      ...
      <%
        ...
        String reportedAtDisp = (reportedAt != null) ? reportedAt.replace('T',' ') : "";
        ...
        if (futureRequests != null) {
          for (String fr : futureRequests) {
            if ("LISTEN_ONLY".equals(fr)) {
              ...
              futureRequestLabels.add("記録として残しておいてほしい");
            } else if ("WORK_CHANGE".equals(fr)) {
              futureRequestLabels.add("配置転換・業務変更を検討してほしい");
            } else if ("NOTHING".equals(fr)) {
              futureRequestLabels.add("特に希望はない");
        ...
        String futureRequestLabelJoined = futureRequestLabels.isEmpty() ? "" : String.join("、", futureRequestLabels);
        ...
        if ("ALL_OK".equals(sharePermission)) {
          ...
          sharePermissionLabel = "相談窓口以外には共有しないでほしい";
        }
      %>
        ...
        <div class="card-body">
          ...
          <dl class="row mb-0">
            ...
            <dd class="col-sm-9 mt-3">
              ...
              <p class="mb-1">相談日時：<%= (reportedAtDisp != null && !reportedAtDisp.isEmpty()) ? reportedAtDisp : "" %></p>
